...
<div class="profile-container">
    ...
    <div class="profile-sidebar">
        ...
        <div class="social-icons">
            ...
            <a href="https://allmylinks.com/agarciao10" target="_blank" rel="noopener noreferrer" title="All My Links" aria-label="Abrir All My Links de Angel García O'Diana"><i class="fas fa-link" aria-hidden="true"></i></a>
        </div>
    </div>
    ...
    <div class="profile-content">
        ...
        <div class="info-grid">
            <div class="info-column">
                <h3 data-i18n="interests_title">Interests</h3>
                <ul class="clean-list">
                    <li data-i18n="int_1">• Peace Psychology</li>
                    <li data-i18n="int_2">• Computational Science</li>
                    <li data-i18n="int_3">• Network Analysis</li>
                    <li data-i18n="int_4">• Psychometrics & Data Science</li>
                </ul>
            </div>

            <div class="info-column">
                <h3 data-i18n="edu_title">Education</h3>
                <ul class="clean-list">
                    <li>
